...
public class BuildTreeListener implements MentalListener {
    /**
    ...
    @Override
    public void enterClassName(MentalParser.ClassNameContext ctx) {

    }

    @Override
    public void exitClassName(MentalParser.ClassNameContext ctx) {

    }

    @Override
    public void enterTypeName(MentalParser.TypeNameContext ctx) {

    }

    @Override
    public void exitTypeName(MentalParser.TypeNameContext ctx) {

    }

    @Override
    public void enterArray(MentalParser.ArrayContext ctx) {

    }

    @Override
    public void exitArray(MentalParser.ArrayContext ctx) {

    }

    @Override
    public void enterType(MentalParser.TypeContext ctx) {

    }

    @Override
    public void exitType(MentalParser.TypeContext ctx) {

    }

    @Override
    public void enterParameter(MentalParser.ParameterContext ctx) {

    }

    @Override
    public void exitParameter(MentalParser.ParameterContext ctx) {

    }

    @Override
    public void enterParametersList(MentalParser.ParametersListContext ctx) {

    }

    @Override
    public void exitParametersList(MentalParser.ParametersListContext ctx) {
     ...
     */
    @Override
    public void enterProgram(MentalParser.ProgramContext ctx) {
    ...
    @Override
    public void exitProgram(MentalParser.ProgramContext ctx) {
     ...
     */
    @Override
    public void enterDeclaration(MentalParser.DeclarationContext ctx) {
    }

    @Override
    public void exitDeclaration(MentalParser.DeclarationContext ctx) {
     ...
     */
    @Override
    public void enterClassDeclaration(MentalParser.ClassDeclarationContext ctx) {
    ...
    @Override
    public void exitClassDeclaration(MentalParser.ClassDeclarationContext ctx) {
    }
     ...
     */
    @Override
    public void enterFunctionDeclaration(MentalParser.FunctionDeclarationContext ctx) {
    }

    @Override
    public void exitFunctionDeclaration(MentalParser.FunctionDeclarationContext ctx) {
    }
     ...
     */
    @Override
    public void enterDefinition(MentalParser.DefinitionContext ctx) {
    }

    @Override
    public void exitDefinition(MentalParser.DefinitionContext ctx) {
     ...
     */
    @Override
    public void enterSingleVariable(MentalParser.SingleVariableContext ctx) {
     ...
     */
    @Override
    public void enterVariableDefinition(MentalParser.VariableDefinitionContext ctx) {
    ...
    @Override
    public void exitVariableDefinition(MentalParser.VariableDefinitionContext ctx) {
        if (ctx.parent instanceof MentalParser.ClassDeclarationContext) {
            return;
        }
     ...
     */
    @Override
    public void enterFunctionDefinition(MentalParser.FunctionDefinitionContext ctx) {
        if (ctx.parent instanceof MentalParser.ClassDeclarationContext) {
            return;
        }
        this.beginScope();
    ...
    @Override
    public void exitFunctionDefinition(MentalParser.FunctionDefinitionContext ctx) {
        if (ctx.parent instanceof MentalParser.ClassDeclarationContext) {
     ...
     */
    @Override
    public void enterStatement(MentalParser.StatementContext ctx) {
    ...
    @Override
    public void exitStatement(MentalParser.StatementContext ctx) {
        // compress the path
        if (ctx.variableDefinition() != null) {
     ...
     */
    @Override
    public void enterCompoundStatement(MentalParser.CompoundStatementContext ctx) {
        // new a scope if it is not the function body.
    ...
    @Override
    public void exitCompoundStatement(MentalParser.CompoundStatementContext ctx) {
        if (!(ctx.parent instanceof MentalParser.FunctionDefinitionContext)) {
            if (ctx.parent instanceof MentalParser.StatementContext
                    && !(ctx.parent.parent instanceof MentalParser.ForStatementContext
                    || ctx.parent.parent instanceof MentalParser.WhileStatementContext
     ...
     */
    @Override
    public void enterEmptyStatement(MentalParser.EmptyStatementContext ctx) {
        EmptyStatement emptyStatement = new EmptyStatement();
        this.tree.put(ctx, emptyStatement);
    }

    @Override
    public void exitEmptyStatement(MentalParser.EmptyStatementContext ctx) {
    }
     ...
     */
    @Override
    public void enterIfStatement(MentalParser.IfStatementContext ctx) {
        IfStatement ifStatement = new IfStatement();
        this.tree.put(ctx, ifStatement);
    }

    @Override
    public void exitIfStatement(MentalParser.IfStatementContext ctx) {
     ...
     */
    @Override
    public void enterIfElseStatement(MentalParser.IfElseStatementContext ctx) {
        IfStatement ifElseStatement = new IfStatement();
        this.tree.put(ctx, ifElseStatement);
    }

    @Override
    public void exitIfElseStatement(MentalParser.IfElseStatementContext ctx) {
        IfStatement thisStatement = (IfStatement) this.tree.get(ctx);
        thisStatement.condition = (Expression) this.tree.get(ctx.expression());
        thisStatement.condition.parent = thisStatement;
        thisStatement.thenStatement = (Statement) this.tree.get(ctx.thenStatement);
     ...
     */
    @Override
    public void enterForStatement(MentalParser.ForStatementContext ctx) {
        ForStatement forStatement = new ForStatement();
        this.tree.put(ctx, forStatement);
    }

    @Override
    public void exitForStatement(MentalParser.ForStatementContext ctx) {
     ...
     */
    @Override
    public void enterWhileStatement(MentalParser.WhileStatementContext ctx) {
        WhileStatement whileStatement = new WhileStatement();
        this.tree.put(ctx, whileStatement);
    }

    @Override
    public void exitWhileStatement(MentalParser.WhileStatementContext ctx) {
     ...
     */
    @Override
    public void enterJumpStatement(MentalParser.JumpStatementContext ctx) {
    ...
    @Override
    public void exitJumpStatement(MentalParser.JumpStatementContext ctx) {
     ...
     */
    @Override
    public void enterExpressionStatement(MentalParser.ExpressionStatementContext ctx) {
    }

    @Override
    public void exitExpressionStatement(MentalParser.ExpressionStatementContext ctx) {
     ...
     */
    @Override
    public void enterLOGICAL_NOT_EXPRESSION(MentalParser.LOGICAL_NOT_EXPRESSIONContext ctx) {
        LogicalNotExpression expression = new LogicalNotExpression();
        this.tree.put(ctx, expression);
    }

    @Override
    public void exitLOGICAL_NOT_EXPRESSION(MentalParser.LOGICAL_NOT_EXPRESSIONContext ctx) {
     ...
     */
    @Override
    public void enterMEMBER_ACCESS_EXPRESSION(MentalParser.MEMBER_ACCESS_EXPRESSIONContext ctx) {
        MemberAccessExpression memberAccessExpression = new MemberAccessExpression();
        this.tree.put(ctx, memberAccessExpression);
    }

    @Override
    public void exitMEMBER_ACCESS_EXPRESSION(MentalParser.MEMBER_ACCESS_EXPRESSIONContext ctx) {
     ...
     */
    @Override
    public void enterFUNCTION_CALL(MentalParser.FUNCTION_CALLContext ctx) {
    ...
    @Override
    public void exitFUNCTION_CALL(MentalParser.FUNCTION_CALLContext ctx) {
     ...
     */
    @Override
    public void enterASSIGN_EXPRESSION(MentalParser.ASSIGN_EXPRESSIONContext ctx) {
        AssignExpression assignExpression = new AssignExpression();
        this.tree.put(ctx, assignExpression);
    }

    @Override
    public void exitASSIGN_EXPRESSION(MentalParser.ASSIGN_EXPRESSIONContext ctx) {
    ...
    @Override
    public void exitCREATION_EXPRESSION(MentalParser.CREATION_EXPRESSIONContext ctx) {
     ...
     */
    @Override
    public void enterSUFFIX_INC_DEC_EXPRESSION(MentalParser.SUFFIX_INC_DEC_EXPRESSIONContext ctx) {
    ...
    @Override
    public void exitSUFFIX_INC_DEC_EXPRESSION(MentalParser.SUFFIX_INC_DEC_EXPRESSIONContext ctx) {
     ...
     */
    @Override
    public void enterPREFIX_INC_DEC_EXPRESSION(MentalParser.PREFIX_INC_DEC_EXPRESSIONContext ctx) {
    ...
    @Override
    public void exitPREFIX_INC_DEC_EXPRESSION(MentalParser.PREFIX_INC_DEC_EXPRESSIONContext ctx) {
     ...
     */
    @Override
    public void enterUNRAY_PLUS_MINUS_EXPRESSION(MentalParser.UNRAY_PLUS_MINUS_EXPRESSIONContext ctx) {
    ...
    @Override
    public void exitUNRAY_PLUS_MINUS_EXPRESSION(MentalParser.UNRAY_PLUS_MINUS_EXPRESSIONContext ctx) {
     ...
     */
    @Override
    public void enterADDITIVE_EXPRESSION(MentalParser.ADDITIVE_EXPRESSIONContext ctx) {
    ...
    @Override
    public void exitADDITIVE_EXPRESSION(MentalParser.ADDITIVE_EXPRESSIONContext ctx) {
     ...
     */
    @Override
    public void enterMULTIPLY_DIVIDE_EXPRESSION(MentalParser.MULTIPLY_DIVIDE_EXPRESSIONContext ctx) {
    ...
    @Override
    public void exitMULTIPLY_DIVIDE_EXPRESSION(MentalParser.MULTIPLY_DIVIDE_EXPRESSIONContext ctx) {
     ...
     */
    @Override
    public void enterBIT_SHIFT_EXPRESSION(MentalParser.BIT_SHIFT_EXPRESSIONContext ctx) {
    ...
    @Override
    public void exitBIT_SHIFT_EXPRESSION(MentalParser.BIT_SHIFT_EXPRESSIONContext ctx) {
     ...
     */
    @Override
    public void enterBIT_AND_EXPRESSION(MentalParser.BIT_AND_EXPRESSIONContext ctx) {
        BitAndExpression bitAndExpression = new BitAndExpression();
        this.tree.put(ctx, bitAndExpression);
    }

    @Override
    public void exitBIT_AND_EXPRESSION(MentalParser.BIT_AND_EXPRESSIONContext ctx) {
     ...
     */
    @Override
    public void enterBIT_OR_EXPRESSION(MentalParser.BIT_OR_EXPRESSIONContext ctx) {
        BitOrExpression bitOrExpression = new BitOrExpression();
        this.tree.put(ctx, bitOrExpression);
    }

    @Override
    public void exitBIT_OR_EXPRESSION(MentalParser.BIT_OR_EXPRESSIONContext ctx) {
     ...
     */
    @Override
    public void enterBIT_XOR_EXPRESSION(MentalParser.BIT_XOR_EXPRESSIONContext ctx) {
        BitXorExpression bitXorExpression = new BitXorExpression();
        this.tree.put(ctx, bitXorExpression);
    }

    @Override
    public void exitBIT_XOR_EXPRESSION(MentalParser.BIT_XOR_EXPRESSIONContext ctx) {
     ...
     */
    @Override
    public void enterBIT_NOT_EXPRESSION(MentalParser.BIT_NOT_EXPRESSIONContext ctx) {
     ...
     */
    @Override
    public void exitBIT_NOT_EXPRESSION(MentalParser.BIT_NOT_EXPRESSIONContext ctx) {
     ...
     */
    @Override
    public void enterRELATION_EXPRESSION(MentalParser.RELATION_EXPRESSIONContext ctx) {
    ...
    @Override
    public void exitRELATION_EXPRESSION(MentalParser.RELATION_EXPRESSIONContext ctx) {
     ...
     */
    @Override
    public void enterEQUALITY_EXPRESSION(MentalParser.EQUALITY_EXPRESSIONContext ctx) {
    ...
    @Override
    public void exitEQUALITY_EXPRESSION(MentalParser.EQUALITY_EXPRESSIONContext ctx) {
     ...
     */
    @Override
    public void enterIDENTIFIER(MentalParser.IDENTIFIERContext ctx) {
    ...
    @Override
    public void exitIDENTIFIER(MentalParser.IDENTIFIERContext ctx) {
     ...
     */
    @Override
    public void enterNULL(MentalParser.NULLContext ctx) {
        this.tree.put(ctx, new NullConstant());
    }

    @Override
    public void exitNULL(MentalParser.NULLContext ctx) {
    }
     ...
     */
    @Override
    public void enterLOGICAL_AND_EXPRESSION(MentalParser.LOGICAL_AND_EXPRESSIONContext ctx) {
    ...
    @Override
    public void exitLOGICAL_AND_EXPRESSION(MentalParser.LOGICAL_AND_EXPRESSIONContext ctx) {
     ...
     */
    @Override
    public void enterLOGICAL_OR_EXPRESSION(MentalParser.LOGICAL_OR_EXPRESSIONContext ctx) {
        SuperLogicalOrExpression superLogicalOrExpression = new SuperLogicalOrExpression();
        this.tree.put(ctx, superLogicalOrExpression);
    }

    @Override
    public void exitLOGICAL_OR_EXPRESSION(MentalParser.LOGICAL_OR_EXPRESSIONContext ctx) {
     ...
     */
    @Override
    public void enterARRAY_SUBSCRIPTING_EXPRESSION(MentalParser.ARRAY_SUBSCRIPTING_EXPRESSIONContext ctx) {
    ...
    @Override
    public void exitARRAY_SUBSCRIPTING_EXPRESSION(MentalParser.ARRAY_SUBSCRIPTING_EXPRESSIONContext ctx) {
     ...
     */
    @Override
    public void enterSUBGROUP_EXPRESSION(MentalParser.SUBGROUP_EXPRESSIONContext ctx) {
        SubgroupExpression subgroupExpression = new SubgroupExpression();
        this.tree.put(ctx, subgroupExpression);
    }

    @Override
    public void exitSUBGROUP_EXPRESSION(MentalParser.SUBGROUP_EXPRESSIONContext ctx) {
     ...
     */
    @Override
    public void enterINT_LITERAL(MentalParser.INT_LITERALContext ctx) {
    ...
    @Override
    public void exitINT_LITERAL(MentalParser.INT_LITERALContext ctx) {
    }
     ...
     */
    @Override
    public void enterSTRING_LITERAL(MentalParser.STRING_LITERALContext ctx) {
    ...
    @Override
    public void exitSTRING_LITERAL(MentalParser.STRING_LITERALContext ctx) {
    }
     ...
     */
    @Override
    public void enterTRUE(MentalParser.TRUEContext ctx) {
    ...
    @Override
    public void exitTRUE(MentalParser.TRUEContext ctx) {
    }
     ...
     */
    @Override
    public void enterFALSE(MentalParser.FALSEContext ctx) {
        BoolConstant node = new BoolConstant();
    ...
    @Override
    public void exitFALSE(MentalParser.FALSEContext ctx) {
    }
     ...
     */
    @Override
    public void enterFunctionCall(MentalParser.FunctionCallContext ctx) {
    ...
    @Override
    public void exitFunctionCall(MentalParser.FunctionCallContext ctx) {
        if (ctx.parent instanceof MentalParser.FUNCTION_CALLContext) {
            return;
        }
        FunctionCall thisCall = (FunctionCall) this.tree.get(ctx);
     ...
     */
    @Override
    public void enterExpressionList(MentalParser.ExpressionListContext ctx) {
        ExpressionList expressionList = new ExpressionList();
        this.tree.put(ctx, expressionList);
    }

    @Override
    public void exitExpressionList(MentalParser.ExpressionListContext ctx) {
